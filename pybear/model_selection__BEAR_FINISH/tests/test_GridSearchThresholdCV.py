...
if test_package == 'sklearn':
    X, y = sk_make_classification(n_classes=_n_classes, n_samples=_rows, n_features=_columns,
                                 n_informative=_columns, n_redundant=0, weights=[0.75, 0.25])
    ...
    X, y = da_make_classification(n_classes=_n_classes, n_samples=_rows, n_features=_columns, n_informative=_columns,
                                 n_redundant=0, weights=[0.9, 0.1], chunks=(_rows//10, _columns))
    if data_type.lower() == 'dataframe':
...
# BEAR THIS WAS TESTED 24_02_11_17_54_00 AND SHOULDNT NEED TO BE "FIXED"
