...
def powerball_big_matrix_methods():
    return [
        'STANDARD',
        'INTERCEPT'
    ]
...
def powerball_big_matrix_config(standard_config, BIG_MATRIX, BASE_BIG_MATRIX, RETAINED_ATTRIBUTES, interaction,
                                int_cutoff, intercept, things_in_intercept):

    bm_method = cnt.load_config_template(standard_config, 'BIG MATRIX', powerball_big_matrix_methods())
