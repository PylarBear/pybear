...
def LEFT1_TOP1_test_cases_calc_methods():
    return [
        'STANDARD',
    ]
...
def LEFT1_TOP1_test_cases_calc(standard_config, TEST_MATRIX, ARRAY_OF_NODES,
                               RETAINED_ATTRIBUTES, SELECT_LINK_FXN, activation_constant):

    tc_method = cnt.load_config_template(standard_config, 'TEST CASES', LEFT1_TOP1_test_cases_calc_methods())
