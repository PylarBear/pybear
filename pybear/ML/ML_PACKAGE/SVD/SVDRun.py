...
#Xsub_test_build_str()                   # return string with package-specific allowed test objects build commands, overwritten in child
# END TEST BUILD DEFINITIONS ##################################################################################################
...
#Xsub_test_calc_str()                    # return string with package-specific allowed test calc commands
# END TEST CALC DEFINITIONS ##################################################################################################
...
class SVDRun(mlrt.MLRunTemplate):
    ...
    def sub_dev_build_str(self):
        # return string with package-specific allowed test matrix build commands
        return ''  # SPECIFIED IN CHILDREN   CANT USE 'RSDFTUVBNA'
    ...
    def sub_test_calc_cmds(self):
        ...
        return [
            'run special SVD test from standard configs(s)'
        ]                       # SPECIFIED IN CHILDREN   CANT USE 'NA'


    def sub_test_calc_str(self):
        # return string with package-specific allowed test calc commands
