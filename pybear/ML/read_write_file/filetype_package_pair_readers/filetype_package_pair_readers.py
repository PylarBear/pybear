import pandas as p
from read_write_file.filetype_package_pair_readers import txt_python_reader as tpr, csv_openpyxl_reader as cor, \
        excel_openpyxl_reader as eor, excel_csv_pandas_reader as ecpr

#CALLED BY read_write_file.read_file_config_run
def filetype_package_pair_readers(user_package, delimiter, object_type, filename, filetype, SHEET, header, use_cols_select,
