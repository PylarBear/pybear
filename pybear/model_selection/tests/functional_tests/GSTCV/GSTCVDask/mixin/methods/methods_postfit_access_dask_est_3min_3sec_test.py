...
class TestDaskGSTCVMethodsPostFit:
    ...
    def test_methods(
        self, _refit, _scoring, _format, X_da, X_ddf, y_da,
        ...
        if _scoring == ['accuracy']:
            ...
            if _refit is False:
                GSTCV = dask_GSTCV_est_log_two_scorers_postfit_refit_false_fit_on_da
            elif _refit == 'accuracy':
                GSTCV = dask_GSTCV_est_log_two_scorers_postfit_refit_str_fit_on_da
            elif callable(_refit):
                GSTCV = dask_GSTCV_est_log_two_scorers_postfit_refit_fxn_fit_on_da
        ...
        if _refit is False:
            ...
            __ = getattr(GSTCV, 'decision_function')(X_dask)
