...
class TestSKSetParams:
    ...
    def test_rejects_junk_params(
        self, junk_param, state, _GSTCV_prefit, _GSTCV_PIPE_prefit,
        _GSTCV_postfit, _GSTCV_PIPE_postfit
    ):
    ...
    def test_rejects_invalid_params(
        self, state, _GSTCV_prefit, _GSTCV_PIPE_prefit, _GSTCV_postfit,
        _GSTCV_PIPE_postfit
    ):
    ...
    def test_accepts_good_params_shallow_no_pipe(
        self, state, _GSTCV_prefit, _GSTCV_postfit
    ):
        ...
        # now that GSTCV no pipe fixture is scoped to class, reset the params
        # to the original before going to the next test
        _GSTCV.set_params(**original_good_params_shallow)
    ...
    def test_accepts_good_params_shallow_pipe(
        self, state, _GSTCV_PIPE_prefit, _GSTCV_PIPE_postfit
    ):
        ...
        assert isinstance(_GSTCV_PIPE.estimator.steps[0][1],
                          sk_CountVectorizer)
        assert isinstance(_GSTCV_PIPE.estimator.steps[1][1],
                          XGBClassifier)
        ...
        # now that GSTCV pipe fixture is scoped to class, reset the params
        # to the original before going to the next test
        _GSTCV_PIPE.set_params(**original_good_params_pipe_shallow)
