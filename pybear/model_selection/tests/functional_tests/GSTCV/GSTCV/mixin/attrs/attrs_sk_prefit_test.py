...
class TestSKAttrsPreFit:
    ...
    def test_attrs_1(self, sk_GSTCV_est_log_one_scorer_prefit,
        sk_GSTCV_pipe_log_one_scorer_prefit, generic_no_attribute_1, attr
    ):

        sk_GSTCV_prefit = sk_GSTCV_est_log_one_scorer_prefit
        sk_GSTCV_PIPE_prefit = sk_GSTCV_pipe_log_one_scorer_prefit
        ...
        with pytest.raises(
            ...
            getattr(sk_GSTCV_PIPE_prefit, attr)
    ...
    def test_classes__n_features_in(self, _scoring, _refit_false, _not_fitted,
        ...
        if _scoring == ['accuracy']:
            ...
            sk_GSTCV_PIPE_prefit = sk_GSTCV_pipe_log_two_scorers_prefit
        ...
        with pytest.raises(AttributeError, match=exp_match):
            sk_GSTCV_PIPE_prefit.n_features_in_
