...
pytest.skip(f"test takes 18 minutes", allow_module_level=True)
...
class TestDaskGSCVSThatDontNeedPartialFit(Fixtures, _Client):
...
class TestDaskGSCVSThatNeedPartialFitButNotSuccessiveHalving(Fixtures, _Client):
...
class TestDaskSuccessiveHalving(Fixtures, _Client):
