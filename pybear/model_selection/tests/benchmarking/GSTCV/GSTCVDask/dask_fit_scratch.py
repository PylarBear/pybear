...
# play with dask KFold and fitting a dask classifier in a for-loop
...
if __name__ == '__main__':
    ...
    with Client(n_workers=4, threads_per_worker=1):  # LocalCluster(n_workers=4, threads_per_worker=1))
        scores = []
