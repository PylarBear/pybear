...
from model_selection.GSTCV._GSTCVDask._validation._is_dask_estimator import _is_dask_estimator
...
def _val_estimator(
    ...
    # this can be fettered out and made to happen only in main _GSTCV
