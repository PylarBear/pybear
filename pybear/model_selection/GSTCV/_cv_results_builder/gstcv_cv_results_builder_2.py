...
"""
pizza, this is the active cv_results_builder in GSTCV. there are 2 things 
still up in the air:
...
def cv_results_builder(
        param_grid: Union[dict[str, any], list[dict[str,any]]],  # pizza check if can be [{}] or {}
        cv: int,
        scorer: Union[str, None, callable],   # pizza verify
        return_train_score: bool
    ) -> Union[dict[str, np.ma.array], list[dict[str, any]]]:

    # pizza, cv_results_ is only used inside the GSTCV fit method!
