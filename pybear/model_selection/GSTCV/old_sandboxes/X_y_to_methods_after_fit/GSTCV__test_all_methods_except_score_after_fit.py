...
for good_or_bad_x in GOOD_OR_BAD_X:
    for _dtype in DTYPES:
        for _gscv_type in TYPES:
            ...
            WIP_METHOD_NAMES.remove('n_features_in_')
            WIP_METHOD_NAMES.remove('feature_names_in_')
            WIP_METHOD_NAMES.remove('classes_')
            ...
            for _method in WIP_METHOD_NAMES:
                ...
                try:
                    ...
                    METHOD_ARRAY_DICT[trial].loc[_method, 'OUTPUT'] = 'pass'
                except:
