...
class TestParamsTotalPasses_Accuracy:
    ...
    def test_accepts_list_like(
        ...
        total_passes, points_container, paramtype, _inf_shrink_pass
    ):
        ...
        out_params, out_total_passes = _cond_params__total_passes(
            {'good_param': _param_value},
            _total_passes=total_passes,
            _inf_shrink_pass=_inf_shrink_pass
        )
        ...
        assert out_total_passes == total_passes
    ...
    def test_overrides_kwarg_passes(
        self, kwarg_passes, good_dict_params, answer_good_dict_params,
            _inf_shrink_pass
    ):
