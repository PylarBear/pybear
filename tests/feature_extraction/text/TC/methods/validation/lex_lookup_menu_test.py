...
from pybear.feature_extraction.text._TC._methods._validation._lex_lookup_menu \
    import _lex_lookup_menu_validation



class TestLexLookupMenuValidation:


    @staticmethod
    @pytest.fixture(scope='module')
    def _lex_lookup_menu_keys():
        return 'ABCD'
    ...
    def test_rejects_junk_allowed(self, junk_allowed, _lex_lookup_menu_keys):

        with pytest.raises(TypeError):

            _lex_lookup_menu_validation(
                _lex_lookup_menu_keys,
    ...
    def test_rejects_junk_disallowed(self, junk_disallowed, _lex_lookup_menu_keys):
    ...
    def test_mix_and_match_None(self, _allowed, _disallowed, _lex_lookup_menu_keys):
        ...
        if _allowed is not None and _disallowed is not None:
            ...
            out = _lex_lookup_menu_validation(
                _lex_lookup_menu_keys,
                _allowed=_allowed,
                _disallowed=_disallowed
            )
    ...
    def test_rejects_impossible_char(self, impossible_char, _lex_lookup_menu_keys):
    ...
    def test_accepts_possible_char(self, possible_char, _lex_lookup_menu_keys):
