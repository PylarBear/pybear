...
from pybear.feature_extraction.text._TextJustifier._transform._stacker import \
    _stacker

from pybear.feature_extraction.text._TextJustifier._transform._splitter import \
    _splitter
