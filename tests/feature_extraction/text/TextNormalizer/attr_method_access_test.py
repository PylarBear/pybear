...
class TestAttrAccess:
    ...
    def test_attr_access(self, has_seen_data, _X_list):
        ...
        assert getattr(TestCls, 'upper') is None
...
class TestMethodAccess:
    ...
    def test_access_methods(self, _X_list, has_seen_data):
        ...
        out = getattr(TestCls, 'set_params')(**{'upper': None})
        assert isinstance(out, TextNormalizer)
        assert TestCls.upper is None
