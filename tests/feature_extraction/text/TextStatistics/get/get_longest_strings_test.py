...
from pybear.feature_extraction.text._TextStatistics._get._get_longest_strings \
    import _get_longest_strings
...
class TestGetLongestStrings:
    ...
    def test_accuracy(self, n):
        ...
        out = _get_longest_strings(FREQ_DICT_1, n)
        ...
        out = _get_longest_strings(FREQ_DICT_2, n)
        ...
        out = _get_longest_strings(FREQ_DICT_3, n)
