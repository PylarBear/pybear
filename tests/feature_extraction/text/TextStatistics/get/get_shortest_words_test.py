...
from pybear.feature_extraction.text._TextStatistics._get._get_shortest_words \
    import _get_shortest_words



class TestGetShortestWords:
    ...
    def test_accuracy(self, n):
        ...
        out = _get_shortest_words(FREQ_DICT_1, n)
        ...
        out = _get_shortest_words(FREQ_DICT_2, n)
        ...
        out = _get_shortest_words(FREQ_DICT_3, n)
