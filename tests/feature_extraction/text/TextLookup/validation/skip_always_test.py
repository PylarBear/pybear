...
from pybear.feature_extraction.text._TextLookup._validation._skip_always import \
    _val_skip_always
...
class TestSkipAlways:
    ...
    def test_accepts_seq_str_or_None(self, container_maker, container):
        ...
        assert _val_skip_always(_seq_2) is None

        assert _val_skip_always(_seq_3) is None
