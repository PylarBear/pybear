...
class TestDaskIncrementalParallelPostFit:
    ...
    @staticmethod
    @pytest.fixture
    def NoDup_not_wrapped(_kwargs):
        return NoDup(**_kwargs)

    @staticmethod
    @pytest.fixture
    def NoDup_wrapped_parallel(_kwargs):
        return ParallelPostFit(NoDup(**_kwargs))

    @staticmethod
    @pytest.fixture
    def NoDup_wrapped_incremental(_kwargs):
        return Incremental(NoDup(**_kwargs))

    @staticmethod
    @pytest.fixture
    def NoDup_wrapped_both(_kwargs):
        return ParallelPostFit(Incremental(NoDup(**_kwargs)))
    ...
    def test_fit_and_transform_accuracy(self, wrappings, NoDup_wrapped_parallel,
        NoDup_wrapped_incremental, NoDup_not_wrapped, NoDup_wrapped_both, _dum_X,
        ...
        if wrappings == 'incr':
            _test_cls = NoDup_wrapped_incremental
        elif wrappings == 'ppf':
            _test_cls = NoDup_wrapped_parallel
        elif wrappings == 'both':
            _test_cls = NoDup_wrapped_both
        elif wrappings == 'none':
            _test_cls = NoDup_not_wrapped
