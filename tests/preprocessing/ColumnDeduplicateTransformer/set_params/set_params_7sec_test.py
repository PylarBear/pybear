...
class TestSetParams:
    ...
    def test_equality_set_params_before_and_after_fit(
        ...
        assert FirstTestClass.do_not_drop == None
        assert FirstTestClass.conflict == 'raise'
        ...
        assert SecondTestClass.do_not_drop == None
        assert SecondTestClass.conflict == 'ignore'
        ...
        assert SecondTestClass.do_not_drop == None
        assert SecondTestClass.conflict == 'raise'
    ...
    def test_set_params_output_repeatability(
        ...
        assert TestClass.do_not_drop == None
        assert TestClass.conflict == 'raise'
        ...
        assert TestClass.do_not_drop == None
        assert TestClass.conflict == 'ignore'
