...
# pizza 25_01_03_12_50_00 this is taken directly from
# MCT._validation
...
def _val_feature_names(
    ...
    # _columns is an output of _handle_X_y, which gets it by X.columns for the currently fit data

    # _feature_names_in is an output of _handle_X_y, which gets it by X.columns on
    #       the first fit data and saves it in self.feature_names_in_
