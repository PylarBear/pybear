...
def _get_best_thresholds(
    ...
    _TEST_FOLD_x_THRESH_x_SCORER__SCORE:
        ...
        holds the 'error_score' value in every position. Otherwise, holds
        scores for every fold / threshold / scorer permutation.
    ...
    -
        ...
        vector of the threshold that had the highest score (or lowest
        loss) for each scorer.
