...
def _int_logspace_gap_gt_1_soft(
    ...
    _LOG_SINGLE_GRID:
        ...
        single soft integer parameter in logspace.
        _LOG_SINGLE_GRID must be sorted ascending, and is presumed to be
        by _param_conditioning._params (at least initially).
    _is_logspace:
