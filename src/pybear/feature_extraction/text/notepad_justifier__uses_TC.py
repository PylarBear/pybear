...
# ALSO SEE text.TextCleaner FOR SIMILAR CODE, IF EVER CONSOLIDATING


def notepad_justifier():

    print(f'*** Reading from file ***')
    # filename = r'C:\Users\Bill\AppData\Local\Programs\Python\Python39\PyCharmProjects\text\notepad.txt'
