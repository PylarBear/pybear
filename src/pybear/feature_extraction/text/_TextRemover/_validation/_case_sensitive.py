...
from .._type_aliases import CaseSensitiveType
...
def _val_case_sensitive(
    ...
    _case_sensitive:
        ...
        case-sensitive search for full strings to remove. If a list-like,
        the entries are applied to the corresponding row in the data.
    _n_rows:
