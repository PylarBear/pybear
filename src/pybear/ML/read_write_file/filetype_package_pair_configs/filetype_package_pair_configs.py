from read_write_file.filetype_package_pair_configs import txt_python_config as tp, \
        csv_openpyxl_config as co, excel_openpyxl_config as eo, excel_csv_pandas_config as ecp
